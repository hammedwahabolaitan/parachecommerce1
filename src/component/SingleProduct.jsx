                        ...
                        <div className="bg-white shadow-md rounded-lg p-4">
                            ...
                            <div className="mt-4">
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <input type="number" className="border text-center w-10" value="1" />
                                    <button className="border rounded px-2 py-1">+</button>
                                </div>
                            </div>
...
//   return (
//     <div className="product-thumbnail lg:col-span-6">
//       {/* Main Slider */}
//       <Slider {...settings} className="product-slick">
...
//       {/* Thumbnail Nav */}
//       <Slider {...settingsNav} className="slider-nav mt-4">
//         <div className="slick-slide">
//           <img
//             src="/assets/images/pro3/3.jpg"
//             alt="olive"
